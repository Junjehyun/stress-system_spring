...
public class KaisyaMst {
    ...
    public String getKaisyaNameJpn() {
        return kaisyaNameJpn;
    }

    public void setKaisyaNameJpn(String kaisyaNameJpn) {
        this.kaisyaNameJpn = kaisyaNameJpn;
    }

    public String getKaisyaNameEng() {
        return kaisyaNameEng;
    }

    public void setKaisyaNameEng(String kaisyaNameEng) {
        this.kaisyaNameEng = kaisyaNameEng;
    }
}
